...
class Settlement(db.Model):
    ...
    trips_from = db.relationship('Trip', foreign_keys='Trip.departure_settlement_id', backref='departure_settlement', lazy='dynamic')
    trips_to = db.relationship('Trip', foreign_keys='Trip.arrival_settlement_id', backref='arrival_settlement', lazy='dynamic')
